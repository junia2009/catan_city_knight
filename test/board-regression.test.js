...
const GOLDEN = {
  ...
  // 蛮族防衛が同点のときの報酬を「本人が山を選ぶ」公式ルールにした時点で更新。
  // PICK_DEFENDER_DECK という手が増えるのでアクション数が変わる(cak/1 は5回、
  // cak/2 は9回、cak/3 は0回。同点が起きない cak/3 のハッシュは変わっていない)。
  'cak/1': '1e68dddbf33f71ff',
  'cak/2': 'f601b7db15ac8872',

...
function setupHtml() {
  ...
  <h4>⬡ ルール — 遊ぶルールを選ぶ</h4>
  ${costRow('🏝', '基本', '10点。発展カードと最大騎士力の、いちばん素直なカタン(既定)')}
...
function seaHtml() {
  ...
  盤がひとまわり広くなり、<b>本島16マス</b>のまわりの海に
  <b>1マスの小島が3つ</b>浮かんでいます。</p>
  <p>最初の開拓地2軒は<b>本島にしか置けません</b>。小島へは船で渡ります。</p>
  ...
  小島は1マスしかないので産出は細いぶん、<b>強い数字(5・6・8)</b>が置かれています。</p>

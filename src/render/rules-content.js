...
function basicHtml(demo) {
  ...
  「プレイヤー」タブでは渡すもの・もらうものを選び、<b>相手を指名して提案</b>します — CPUも
  オンラインの相手も同じ流れで応諾/拒否します(同じ相手への提案は1手番に1回まで)。</p>
  ...
  <h4>📜 発展カード(基本ルール)</h4>
  <p>⚔️騎士(盗賊を移動・3枚で最大騎士力+2点) / 🛤️街道建設(道2本を<b>自分で選んで</b>無料建設) /
...
function setupHtml() {
  ...
  ${costRow('🏝', '基本', '10点。発展カードと最大騎士力の、いちばん素直なカタン。迷ったらこれ')}
  ${costRow('🐉', 'ドラゴン', '12点。基本＋ドラゴンが暴れるオリジナルルール')}
  <p>それぞれの詳しい違いは上のタブ(基本 / 都市と騎士 / 🐉ドラゴン)にあります。</p>

  <h4>🤖 CPU — 一緒に遊ぶ人数</h4>
  <p><b>2体</b>なら自分を入れて3人戦、<b>3体</b>なら4人戦。
  人数が多いほど盤面の土地の取り合いが激しくなり、1周にかかる時間も長くなります。
  <b>迷ったら3体</b>(標準のカタンと同じ4人戦)。</p>
  ...
  ${costRow('🎰', '純ランダム', '毎回ゼロから2個振る。ふつうのサイコロと同じ')}
  <p><b>バランス</b>だと36回のあいだの出目分布が必ず理論どおりになるので、
  「6と8が延々出ない」「7ばかり続く」といった偏りが起きません(既定)。
  山札の残り枚数はダイスの横に🂠で出ます。
  本物のサイコロの手触りがいいなら<b>純ランダム</b>を選んでください。</p>
  <p>対戦中は<b>ダイスの横の📊</b>から「出目の記録」を開けます。
  2〜12が何回出たかを棒グラフで見られ、いまの回数ぶんの理論値が点線で重なるので、
  偏っているかどうかを自分の目で確かめられます。</p>
